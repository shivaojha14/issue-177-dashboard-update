...
import mr1 from "../Images/GettyImages-1343006928-1401x788-49696df.webp";
...
export default function RiskManagement() {
    return (
        <>
            ...
            <title>Risk Management |  Compilanace and Risk Management:: indsaccrm.com</title>
                ...
                <div class="about-inner inner2">
                    <div class="container seen-w3">
                        <ul class="breadcrumbs-custom-path">
                            ...
                            <li class="active">Compilanace and Risk Management</li>
                        </ul>
                    </div>
                </div>
            </section>
