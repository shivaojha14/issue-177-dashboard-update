...
export default function LogisticsAndShipping() {
    return (
        <>
                {/* <!-- Required meta tags --> */}
                <meta charset="utf-8" />
                ...
                <title>Logistics And Shipping | Digital & Mobile :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Logistics And Shipping</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    <h4>Logistics and Shipping</h4>
                                    <p className="para"> 
                                    Logistics and Shipping manage the transportation and delivery of goods to customers or distribution centers. This module coordinates with carriers, manages shipping routes, and tracks shipments in real-time.
                                    </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Logistics and Shipping</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Cost Optimization</h4>
                                            <p className="para">  Reduces transportation costs through effective carrier selection and route management.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Improves delivery times and accuracy, enhancing customer experience.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">Provides visibility into shipments, allowing for proactive management of potential delays.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4>Integration</h4>
                                            <p className="para"> Seamlessly integrates with Warehouse Management and Order Management for cohesive shipping processes.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
