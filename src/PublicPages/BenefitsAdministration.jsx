...
export default function BenefitsAdministration() {
    return (
        <>
                ...
                <title>Mobile ERP | Digital & Mobile :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Benefits Administration</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    Benefits Administration manages employee benefits, such as health insurance, retirement plans, 
                                    and other perks. This module automates the enrollment process, tracks eligibility, and ensures compliance
                                     with benefits regulations. It provides employees with self-service options to manage their benefits, 
                                     reducing the administrative burden on HR staff. Integration with payroll ensures that deductions and 
                                     contributions are accurately
                                     processed, and reporting tools help HR professionals analyze benefits usage and costs. </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Benefits Administration</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Automated Benefits Enrollment</h4>
                                            <p className="para">  Streamlines the process of enrolling employees in benefits programs, reducing administrative overhead.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4>Compliance with Benefits Regulations</h4>
    
                                            <p className="para">   : Ensures that benefits administration complies with applicable laws and regulations, minimizing legal risks.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">  Provides employees with tools to manage their benefits, reducing the administrative burden on HR staff.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
