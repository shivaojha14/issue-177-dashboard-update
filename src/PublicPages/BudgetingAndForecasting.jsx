...
export default function BudgetingAndForecasting() {
    return (
        <>
                ...
                <title>Mobile ERP | Budgeting and Forecasting :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Budgeting and Forecasting</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para">Budgeting and Forecasting are essential for financial
                                         planning and decision-making. This module allows organizations to create detailed financial 
                                         budgets, set targets, and compare actual performance against budgeted figures. It provides tools
                                          for scenario analysis, enabling businesses to anticipate the financial impact of different strategies
                                           or market conditions. The integration with other financial modules ensures that budgeting is based on
                                            real-time data, making the forecasts more accurate and reliable.
                                    </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Budgeting and Forecasting </h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Financial Planning</h4>
                                            <p className="para">   Enables the creation of detailed financial budgets and forecasts, helping organizations set financial goals and expectations.</p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">  Provides tools for analyzing different financial scenarios, allowing businesses to prepare for various market conditions. <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">  Ensures that budgets and forecasts are based on up-to-date financial data, increasing their accuracy and relevance.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
