...
export default function ContactManagement() {
    return (
        <>
                ...
                <title>Contact Management | Digital & Mobile :: indsaccrm.com</title>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    Contact Management is a core function of the CRM module that centralizes all customer information 
                                    in one place. It stores details such as contact information, communication history, and customer preferences. 
                                    This module provides a 360-degree view of the customer, enabling sales, marketing, and support teams to access 
                                    relevant information quickly and efficiently. Contact Management also helps in segmenting customers based on 
                                    various criteria, allowing for targeted marketing and personalized customer interactions.
                                    </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Contact Management</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Centralized Customer Data</h4>
                                            <p className="para"> Stores all customer information in one place, making it easily accessible to all teams.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Facilitates targeted marketing by segmenting customers based on detailed criteria.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">  Provides a complete view of customer interactions, aiding in better decision-making.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Ensures all teams have access to the same up-to-date information, improving coordination and customer service.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
