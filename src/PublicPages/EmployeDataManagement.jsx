...
export default function EmployeDataManagement() {
    return (
        <>
                {/* <!-- Required meta tags --> */}
                <meta charset="utf-8" />
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Employee Data Management</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    Employee Data Management is the foundation of the HR module. It involves the collection, storage,
                                     and management of all employee-related information, including personal details, employment history, 
                                     job roles, and performance records. This module ensures that employee data is secure, up-to-date, and
                                      easily accessible for HR professionals. It also supports 
                                    the management of organizational structures, reporting lines, and compliance with data privacy regulations
                                          </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Employee Data Management</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Centralized Employee Information</h4>
                                            <p className="para">  Consolidates all employee data in one place, making it easily accessible and ensuring data consistency.</p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Protects sensitive employee information, ensuring it is securely stored and compliant with data privacy regulations.
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4> Efficient HR Operations</h4>
                                            <p className="para">  Simplifies HR tasks such as updating employee records and managing organizational structures.</p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    </div>
