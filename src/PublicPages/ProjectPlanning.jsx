...
export default function ProjectPlanning() {
    return (
        <>
                ...
                <title>Project Planning | Digital & Mobile :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Project Planning</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    Project Planning is the foundation of the Project Management module. It involves defining the project 
                                    scope, setting objectives, and creating detailed project schedules. This function helps project managers 
                                    identify key milestones, allocate resources, and establish timelines for each task. By using Gantt charts, 
                                    critical path analysis, and other planning tools, this module ensures that projects are well-structured 
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Project Planning</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Enhanced Clarity</h4>
                                            <p className="para"> Clearly define project scope, objectives, and timelines to avoid scope creep and ensure stakeholder buy-in.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Allocate resources efficiently, reducing waste and maximizing productivity.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Foster seamless communication among team members, stakeholders, and sponsors through transparent project plans.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">Identify potential roadblocks and develop mitigation strategies to minimize project delays and cost overruns.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Leverage real-time project data to inform strategic decisions and drive business growth.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
