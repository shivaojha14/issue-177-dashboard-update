...
export default function OrderManagement() {
    return (
        <>
                ...
                <title>Order Management | Digital & Mobile :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Order Management</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    Order Management handles the processing of customer orders, from order entry to fulfillment. This module ensures 
                                    that orders are accurately captured, processed, and delivered on time.
                                    </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Order Management</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Customer Satisfaction</h4>
                                            <p className="para">  Improves order accuracy and delivery times, leading to higher customer satisfaction and loyalty.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">Coordinates seamlessly with production and shipping teams to streamline the order fulfillment process.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Integrates with CRM to provide insights into customer preferences and order history.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">Manages invoicing, returns processing, and order tracking, ensuring a complete order lifecycle management.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
