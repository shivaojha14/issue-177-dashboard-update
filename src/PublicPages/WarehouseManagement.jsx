...
export default function WarehouseManagement() {
    return (
        <>
                ...
                <title>Warehouse Management | Digital & Mobile :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Warehouse Management</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    The Warehouse Management module optimizes the storage, retrieval, and movement of goods within warehouses. It provides tools for managing warehouse layouts, bin locations, and stock movements.
                                    </p>
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Warehouse Management</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Increased Efficiency</h4>
                                            <p className="para">  Automates picking, packing, and shipping processes to reduce errors and improve speed.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para">Optimizes warehouse operations to lower operational costs.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            ...
                                            <p className="para"> Supports barcode scanning, RFID tagging, and cross-docking, enhancing accuracy and efficiency.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4> Improved Fulfillment</h4>
                                            <p className="para"> Ensures timely order fulfillment by optimizing warehouse layout and operations.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
