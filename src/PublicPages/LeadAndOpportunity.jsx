...
export default function LeadAndOpportunity() {
    return (
        <>
                {/* <!-- Required meta tags --> */}
                <meta charset="utf-8" />
                ...
                <title>Lead and Opportunity Management | Digital & Mobile :: indsaccrm.com</title>
                    ...
                    <div className="about-inner inner2">
                        <div className="container seen-w3">
                            <ul className="breadcrumbs-custom-path">
                                ...
                                <li className="active">Lead and Opportunity Management</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="cwp4-two row">
                                ...
                                <div className="cwp4-text col-xl-6">
                                    ...
                                    <p className="para"> 
                                    Lead and Opportunity Management focuses on capturing, tracking, and managing leads throughout the sales 
                                    funnel. This module provides tools for qualifying leads, assigning them to sales representatives, and 
                                    tracking their progress through the sales pipeline. It also helps in identifying high-potential opportunities, 
                                    forecasting sales revenue, and optimizing sales strategies. By integrating with Sales Force Automation and 
                                    Marketing Automation, Lead and Opportunity Management ensures that leads are nurtured effectively and that 
                    ...
                    <div className="recent-work ">
                        <div className="container">
                            <div className="left-text">
                                ...
                                <h3>Here are some benefits of Lead and Opportunity Management</h3>
                                <div className="row about-about">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="about-grids">
    
                                            <h4>Effective Lead Management</h4>
                                            <p className="para">Captures and tracks leads throughout the sales funnel, ensuring no opportunities are lost.
                                            </p><br />
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4>Increased Sales Conversion</h4>
    
                                            <p className="para">  Helps in identifying and prioritizing high-potential opportunities, improving sales performance.
                                            <br /><br /></p><br />
                                            <div className="mt-3 about-list">
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4>Accurate Sales Forecasting</h4>
                                            <p className="para">Provides insights into lead progress and potential revenue, aiding in more precise sales forecasting.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 about-line-top">
                                        <div className="about-grids">
                                            <h4>Aligned Sales and Marketing</h4>
                                            <p className="para">Ensures seamless integration between sales and marketing efforts, driving better results.
                                            </p><br />
                                            <div className="mt-3 about-list">
                                            </div>
                                        </div>
